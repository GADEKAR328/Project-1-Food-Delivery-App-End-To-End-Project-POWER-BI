...
- Analyze order trends, customer behavior, and product performance
- Identify high-performing food items and categories
...
The dataset consists of transactional-level data including:

- Order quantity and transaction details
- Food categories and individual menu items
- Customer membership types (Gold, Regular)
...
- Total Quantity: 15.10K orders delivered
...
- Top-performing category: Main Course (1257 orders)
...
- Samosa (2427 orders) – highest selling item
...
- Higher engagement
- Potential loyalty-driven revenue
...
8. 📈 Time-Based Transaction Trends
...
- Samosa & Butter Chicken are star products → ideal for promotions & combos
- Gold members are high-value customers → loyalty programs should be expanded
- UPI adoption is high → incentivize digital payments further
- High delivery success rate (94%) → strong logistics performance
